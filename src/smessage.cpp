...
// Copyright (c) 2015 The PokeCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("pokecoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("pokecoin-smsg-pow"); // Make this thread recognisable
