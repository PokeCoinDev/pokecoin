...
const string strMessageMagic = "PokeCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PokeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "PokeCoin";
        CTransaction txNew;
        txNew.nTime = 1469500000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1469500000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 53762 : 53762;
...
//        assert(block.hashMerkleRoot == uint256("0xeb42ae0324ea968b5cdcd959104fc3b1cd93c45e25ba5be25b5e55deaf21254c"));
        assert(block.hashMerkleRoot == uint256("0x79430eace0b7745a46c0376e4b84383cc6a639e6873fc560eba08e76e4d9fc68"));
...
unsigned char pchMessageStart[4] = { 0x1b, 0x3a, 0x1c, 0x02 };
